...
\begin{figure}[htbp]
    \includegraphics[width=0.8\textwidth,natwidth=206,natheight=150]{./KNN_Ejemplos.png}
...
\begin{figure}[htbp]
    \includegraphics[width=0.8\textwidth,natwidth=206,natheight=150]{./CompararAciertos.png}
...
\begin{figure}[htbp]
    \includegraphics[width=0.8\textwidth,natwidth=206,natheight=150]{./AciertosFin.png}
    \caption{Comparar las tasas de acierto con los 3 clasificadores}
\end{figure}
...
\begin{figure}[htbp]
    \includegraphics[width=0.8\textwidth,natwidth=206,natheight=150]{./CompararTiempos.png}
...
\begin{figure}[htbp]
    \includegraphics[width=0.8\textwidth,natwidth=206,natheight=150]{./CompararAciertosvsTiempos.png}
